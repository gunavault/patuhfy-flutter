...
class GlobalStyle {
  ...
  static const TextStyle viewAll = TextStyle(
      fontSize: 13, fontWeight: FontWeight.bold, color: PRIMARY_COLOR_v2);
  ...
  static const TextStyle orderAction = TextStyle(
      fontSize: 12, color: PRIMARY_COLOR_v2, fontWeight: FontWeight.bold);
  ...
  static const TextStyle preferredMerchant = TextStyle(
      color: PRIMARY_COLOR_v2, fontWeight: FontWeight.bold, fontSize: 12);
  ...
  static const TextStyle outletTagBold =
