  ...
  runApp(
    MultiBlocProvider(
      providers: [
        ...
        BlocProvider(
          create: (context) => SelectboxAfdelingPengolahanCubit(
        ...
        BlocProvider(
          create: (context) =>
              SelectboxBlokPengolahanCubit(localDataSource, remoteDataSource),
        ),
        BlocProvider(
          create: (context) =>
        ...
        BlocProvider(
          create: (context) =>
              SelectboxKondisiPksCubit(localDataSource, remoteDataSource),
        ),
        BlocProvider(
          create: (context) =>
              SelectboxAlatByStasiunCubit(localDataSource, remoteDataSource),
        ),
        BlocProvider(
          create: (BuildContext context) =>
        ...
        BlocProvider(
            create: (BuildContext context) =>
                CekRutinSortasiCardCubit(localDataSource, remoteDataSource)
                  ..checkIsAnwered(today.toString())),
        BlocProvider(
            create: (BuildContext context) =>
                CekRutinSortasiFormCubit(localDataSource, remoteDataSource)),
        BlocProvider(
            create: (BuildContext context) =>
        ...
        BlocProvider(
            create: (BuildContext context) => PelaporanKerusakanAlatFormCubit(
                localDataSource, remoteDataSource)),
        BlocProvider(
            create: (BuildContext context) => PelaporanKerusakanAlatListCubit(
                localDataSource, remoteDataSource)),
      ],
      child: MyApp(
