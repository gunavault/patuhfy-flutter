...
class RealPenunasanDetailCard extends StatelessWidget {
  const RealPenunasanDetailCard({super.key, required this.dataForm});

  final RealPenunasanFormModel? dataForm;

  Widget evidenceRealPenunasan(context) {
          ...
          child: Column(
            ...
            children: [
              ...
              textFieldWidget(
                ...
                fieldValue: dataForm!.rencanaLuasPenunasan,
              ),
              textFieldWidget(
                fieldText: 'Realisasi Luas penunasan',
                fieldValue: dataForm!.realisasiLuasPenunasan,
              ),
              textFieldWidget(
                fieldText: 'Penyebab',
