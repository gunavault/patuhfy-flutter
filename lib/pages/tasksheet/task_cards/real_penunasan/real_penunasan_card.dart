...
class RealPenunasanCard extends StatelessWidget {
  const RealPenunasanCard(
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<RealPenunasanCardCubit, RealPenunasanCardState>(
      builder: (context, state) {
        if (state is IsRealPenunasanAswered) {
          void timesheetAddPopUp(context) {
            showDialog(
              ...
              builder: (BuildContext context) {
                ...
                return RealPenunasanDetailCard(
                      ...
                      if (!state.isAnswered) {
                        if (isToday) {
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (context) => FormRealPenunasan(
