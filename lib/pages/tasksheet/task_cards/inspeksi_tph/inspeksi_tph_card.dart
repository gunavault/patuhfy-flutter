...
import 'package:patuhfy/pages/forms/inspeksi_tph/form_inspeksi_tph.dart';
import 'package:patuhfy/pages/network/disconnected.dart';
import 'package:patuhfy/pages/tasksheet/task_cards/inspeksi_tph/inspeksi_tph_detail_card.dart';
import 'package:patuhfy/utils/common_colors.dart';
import 'package:patuhfy/utils/text_style.dart';
import 'package:patuhfy/widgets/constant.dart';

class InspeksiTphCard extends StatelessWidget {
  const InspeksiTphCard(
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<InspeksiTphCardCubit, InspeksiTphCardState>(
      builder: (context, state) {
        if (state is IsInspeksiTphAswered) {
          void timesheetAddPopUp(context) {
            showDialog(
              barrierDismissible: false,
              context: context,
              builder: (BuildContext context) {
                return InspeksiTphDetailCard(
                      ...
                      if (!state.isAnswered) {
                        if (isToday) {
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (context) => FormInspeksiTph(
