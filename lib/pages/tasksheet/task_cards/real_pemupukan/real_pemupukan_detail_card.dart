...
class RealPemupukanDetailCard extends StatelessWidget {
  const RealPemupukanDetailCard({super.key, required this.dataForm});

  final RealPemupukanFormModel? dataForm;

  Widget evidenceRealPemupukan(context) {
          ...
          child: Column(
            ...
            children: [
              ...
              textFieldWidget(
                ...
                fieldValue: dataForm!.realisasiLuasPemupukan,
              ),
              textFieldWidget(
                fieldText: 'Penyebab',
