...
import 'package:patuhfy/pages/forms/real_penyiangan/form_real_penyiangan.dart';
import 'package:patuhfy/pages/network/disconnected.dart';
import 'package:patuhfy/pages/tasksheet/task_cards/real_penyiangan/real_penyiangan_detail_card.dart';
import 'package:patuhfy/utils/common_colors.dart';
import 'package:patuhfy/utils/text_style.dart';
import 'package:patuhfy/widgets/constant.dart';

class RealPenyianganCard extends StatelessWidget {
  const RealPenyianganCard(
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<RealPenyianganCardCubit, RealPenyianganCardState>(
      builder: (context, state) {
        if (state is IsRealPenyianganAswered) {
          void timesheetAddPopUp(context) {
            showDialog(
              ...
              builder: (BuildContext context) {
                ...
                return RealPenyianganDetailCard(
                      ...
                      if (!state.isAnswered) {
                        if (isToday) {
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (context) => FormRealPenyiangan(
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Melakukan Realisasi Penyiangan',
                                  style: CommonStyle.getRalewayFont(
