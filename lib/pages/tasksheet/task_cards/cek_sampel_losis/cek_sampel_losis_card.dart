...
class CekSampelLosisCard extends StatelessWidget {
  const CekSampelLosisCard(
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<CekSampelLosisCardCubit, CekSampelLosisCardState>(
      builder: (context, state) {
        print('asdasdsa $state');

        if (state is NoConnectionCekSampelLosisCardState) {
          return Container(
            child: Text('No Internet'),
          );
        }
        if (state is IsCekSampelLosisAswered) {
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Melakukan Monitoring Cek Sampel Losis',
                                  style: CommonStyle.getRalewayFont(
