...
class RealRestanDetailCard extends StatelessWidget {
  const RealRestanDetailCard({super.key, required this.dataForm});

  final RealRestanFormModel? dataForm;

  Widget evidenceRealRestan(context) {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // ),
              textFieldWidget(
                fieldText: 'Jumlah Tandan Dipanen',
                fieldValue: dataForm!.jmlTandanDipanen,
              ),
              textFieldWidget(
                fieldText: 'Jumlah Tandan Diangkut',
                fieldValue: dataForm!.jmlTandanDiangkut,
              ),
              textFieldWidget(
                fieldText: 'restan Hari ini',
                fieldValue: dataForm!.restanHi,
              ),
              textFieldWidget(
                fieldText: 'restan kemarin',
                fieldValue: dataForm!.restanKemarin,
              ),
              textFieldWidget(
                fieldText: 'Penyebab',
                fieldValue: dataForm!.ketKendala,
              ),
              textFieldWidget(
