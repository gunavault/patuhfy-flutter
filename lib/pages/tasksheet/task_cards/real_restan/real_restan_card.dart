...
class RealRestanCard extends StatelessWidget {
  const RealRestanCard(
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<RealRestanCardCubit, RealRestanCardState>(
      builder: (context, state) {
        if (state is IsRealRestanAswered) {
                      ...
                      if (!state.isAnswered) {
                        if (isToday) {
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (context) => FormRealRestan(
