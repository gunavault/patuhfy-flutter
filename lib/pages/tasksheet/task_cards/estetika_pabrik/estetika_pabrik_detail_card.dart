...
class EstetikaPabrikDetailCard extends StatelessWidget {
  const EstetikaPabrikDetailCard({super.key, required this.dataForm});
      ...
      children: [
        ...
        Container(
          ...
          child: TextFormField(
            ...
            initialValue: dataForm!.jenisKebersihan,
            enabled: false,
            decoration: InputDecoration(
              contentPadding: const EdgeInsets.only(
                  left: 16, right: 18, top: 16, bottom: 16),
              labelText: 'Jenis Kebersihan',
              fillColor: Colors.transparent,
              hintStyle: CommonStyle.getRalewayFont(
                  color: const Color.fromARGB(255, 0, 0, 0),
                  fontWeight: FontWeight.w400,
  ...
  Widget evidenceEstetikaPabrik(context) {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              fieldJenisKebersihan(),
              evidenceEstetikaPabrik(context),
