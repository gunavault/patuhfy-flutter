...
class EstetikaPabrikListView extends StatelessWidget {
  final String? titleText;
  final Function? onTap;

  const EstetikaPabrikListView({this.titleText, this.onTap, Key? key})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        BlocBuilder<EstetikaPabrikListCubit, EstetikaPabrikListState>(
          builder: (context, state) {
            if (state is LoadingEstetikaPabrikListState) {
              print('tolonggg');
              return const CircularProgressIndicator();
              
            }

            if (state is SuccessEstetikaPabrikListState) {
                            print('bisaaaaa');
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      // Text(
                                      //   'Jumlah Tandan : ${state.dataForm[index].realisasiEstetikaPabrikTandan.toString()} Tandan' ??
                                      //       "",
                                      //   textAlign: TextAlign.start,
                                      //   style: CommonStyle.getRalewayFont(
                                      //     color: CommonColors.blackColor,
                                      ...
                                      Text(
                                        '${state.data[index].jenisKebersihan}',
                                        style: CommonStyle.getRalewayFont(
