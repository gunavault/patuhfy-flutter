...
class ListCekSampelLosis extends StatelessWidget {
  const ListCekSampelLosis({super.key, required this.selectedDate});

  final String selectedDate;

  @override
  Widget build(BuildContext context) {
    BlocProvider.of<CekSampelLosisListCubit>(context).getData(selectedDate);
