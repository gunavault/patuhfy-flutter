...
class CekSampelLosisListView extends StatelessWidget {
  final String? titleText;
  final Function? onTap;

  const CekSampelLosisListView({this.titleText, this.onTap, Key? key})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        BlocBuilder<CekSampelLosisListCubit, CekSampelLosisListState>(
          builder: (context, state) {
            if (state is LoadingCekSampelLosisListState) {
              print('tolonggg');
              return const CircularProgressIndicator();
              
            }

            if (state is SuccessCekSampelLosisListState) {
                            print('bisaaaaa');
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      // Text(
                                      //   'Jumlah Tandan : ${state.dataForm[index].realisasiCekSampelLosisTandan.toString()} Tandan' ??
                                      //       "",
                                      //   textAlign: TextAlign.start,
                                      //   style: CommonStyle.getRalewayFont(
                                      //     color: CommonColors.blackColor,
