...
class FormApelPengolahan extends StatelessWidget {
  FormApelPengolahan({Key? key, required this.selectedDate}) : super(key: key);
  final _formKey = GlobalKey<FormState>();
  final String selectedDate;
  @override
  Widget build(BuildContext context) {
    TextEditingController imageNameController = TextEditingController();
    TextEditingController jenisApelController = TextEditingController();
    ...
    void _postToDatabase() {
      ...
      context.read<ApelPengolahanFormCubit>().submitToDatabase(
            ApelPengolahanFormModel(
                jenisApel: jenisApelController.text,
    ...
    void onChangeSelectboxJenisApel(value) {
    ...
    return GestureDetector(
      ...
      child: BlocListener<ApelPengolahanFormCubit, ApelPengolahanFormState>(
        listener: (context, ApelPengolahanFormState) {
          ...
          } else if (ApelPengolahanFormState
              is SuccessApelPengolahanFormState) {
            ScaffoldMessenger.of(context).hideCurrentSnackBar();
            showAlertSuccessOkActionV2(context, ApelPengolahanFormState.message,
                () {
              ...
              is DuplicatedApelPengolahanFormState) {
              ...
              ..showSnackBar(
                SnackBar(
                  content: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text(ApelPengolahanFormState.message),
          ...
          } else if (ApelPengolahanFormState is ErrorApelPengolahanFormState) {
            context.loaderOverlay.hide();
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text(ApelPengolahanFormState.message.toString()),
                    const Icon(Icons.error)
                  ],
                ),
