...
class SelectboxTenagaPengoperasian extends StatelessWidget {
  const SelectboxTenagaPengoperasian(
      {super.key,
      this.titleName,
      this.isTitleName,
  ...
  Widget build(BuildContext context) {
    BlocProvider.of<SelectboxTenagaPengoperasianCubit>(context).getData();
    Widget _customPopupItemBuilderExample2(
        BuildContext context, TenagaPengoperasianModel item, bool isSelected) {
      return Container(
        ...
        child: ListTile(
          selected: isSelected,
          title: Text(item.namaTenagaPengoperasian.toString()),
    ...
    return Column(
      ...
      children: [
        ...
        DropdownSearch<TenagaPengoperasianModel>(
          validator: (value) {
            if (value == null) {
          ...
          asyncItems: (String? filter) =>
              BlocProvider.of<SelectboxTenagaPengoperasianCubit>(context)
                  .getData(),
          ...
          compareFn: (item, sItem) =>
              item.namaTenagaPengoperasian == sItem.namaTenagaPengoperasian,
