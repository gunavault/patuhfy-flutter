...
class SelectboxSampelLosis extends StatelessWidget {
  const SelectboxSampelLosis(
      {super.key,
      this.titleName,
      this.isTitleName,
  ...
  Widget build(BuildContext context) {
    BlocProvider.of<SelectboxSampelLosisCubit>(context).getData();
    Widget _customPopupItemBuilderExample2(
        BuildContext context, SampelLosisModel item, bool isSelected) {
      return Container(
        ...
        child: ListTile(
          selected: isSelected,
          title: Text(item.namasampellosis.toString()),
    ...
    return Column(
      ...
      children: [
        ...
        DropdownSearch<SampelLosisModel>(
          validator: (value) {
            if (value == null) {
              return 'SampelLosis Tidak Boleh kosong';
            }
            return null;
          },
          onChanged: (value) {
          ...
          compareFn: (item, sItem) => item.namasampellosis == sItem.namasampellosis,
