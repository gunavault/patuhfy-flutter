...
class SelectboxKebun extends StatelessWidget {
  const SelectboxKebun(
      {super.key,
      this.titleName,
      this.isTitleName,
  ...
  Widget build(BuildContext context) {
    BlocProvider.of<SelectboxKebunCubit>(context).getData();
    Widget _customPopupItemBuilderExample2(
        BuildContext context, KebunModel item, bool isSelected) {
      return Container(
    ...
    return Column(
      ...
      children: [
        ...
        DropdownSearch<KebunModel>(
          validator: (value) {
            if (value == null) {
              return 'Kebun Tidak Boleh kosong';
            }
            return null;
          },
          onChanged: (value) {
