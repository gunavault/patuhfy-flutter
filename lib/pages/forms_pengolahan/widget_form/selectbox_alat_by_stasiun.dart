...
class SelectboxAlatByStasiun extends StatelessWidget {
  const SelectboxAlatByStasiun(
      {super.key,
      this.titleName,
      this.isTitleName,
  ...
  Widget build(BuildContext context) {
    Widget _customPopupItemBuilderExample2(
        BuildContext context, AlatByStasiunModel item, bool isSelected) {
      return Container(
        ...
        child: ListTile(
          selected: isSelected,
          title:
              Text('${item.kodeAlat.toString()} (${item.namaAlat.toString()})'),
    ...
    return BlocBuilder<SelectboxAlatByStasiunCubit,
        SelectboxAlatByStasiunState>(
        ...
        if (state is SetParamSBState) {
          ...
          return Column(
            ...
            children: [
              ...
              DropdownSearch<AlatByStasiunModel>(
                validator: (value) {
                  if (value == null) {
                    return 'AlatByStasiun Tidak Boleh kosong';
                  }
                  return null;
                },
                onChanged: (value) {
                ...
                asyncItems: (String? filter) =>
                    BlocProvider.of<SelectboxAlatByStasiunCubit>(context)
                        .getData(state.kodeMandor),
                itemAsString: (AlatByStasiunModel u) => u.userAsString(),
                popupProps: PopupPropsMultiSelection.modalBottomSheet(
                  showSelectedItems: true,
                  itemBuilder: _customPopupItemBuilderExample2,
                  showSearchBox: true,
                ),
                compareFn: (item, sItem) => item.kodeAlat == sItem.kodeAlat,
