...
class SelectboxKondisiProses extends StatelessWidget {
  const SelectboxKondisiProses(
      {super.key,
      this.titleName,
      this.isTitleName,
  ...
  Widget build(BuildContext context) {
    BlocProvider.of<SelectboxKondisiProsesCubit>(context).getData();
    Widget _customPopupItemBuilderExample2(
        BuildContext context, KondisiProsesModel item, bool isSelected) {
      return Container(
        ...
        child: ListTile(
          selected: isSelected,
          title: Text(item.namaKondisiProses.toString()),
    ...
    return Column(
      ...
      children: [
        ...
        DropdownSearch<KondisiProsesModel>(
          validator: (value) {
            if (value == null) {
          ...
          compareFn: (item, sItem) =>
              item.namaKondisiProses == sItem.namaKondisiProses,
