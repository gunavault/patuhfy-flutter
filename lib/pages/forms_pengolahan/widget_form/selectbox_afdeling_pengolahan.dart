...
class SelectboxAfdelingPengolahan extends StatelessWidget {
  const SelectboxAfdelingPengolahan(
      {super.key,
      this.titleName,
      this.isTitleName,
  ...
  Widget build(BuildContext context) {
      ...
      return Container(
        ...
        child: ListTile(
          ...
          title: Text(
              ...
              'Kode Afdeling :  ${item.kodeAfd.toString()}'),
    ...
    return BlocBuilder<SelectboxAfdelingPengolahanCubit, SelectboxAfdelingPengolahanState>(
      builder: (context, state) {
        if (state is SetParamSBState) {
          BlocProvider.of<SelectboxAfdelingPengolahanCubit>(context).getData(state.kodepsa);
              ...
              DropdownSearch<AfdelingModel>(
                ...
                asyncItems: (String? filter) =>
                    BlocProvider.of<SelectboxAfdelingPengolahanCubit>(context)
                        .getData(state.kodepsa),
                    itemAsString: (AfdelingModel u) => u.toString(),
