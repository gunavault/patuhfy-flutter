...
class SelectboxJenisKerusakan extends StatelessWidget {
  const SelectboxJenisKerusakan(
      {super.key,
      this.titleName,
      this.isTitleName,
  ...
  Widget build(BuildContext context) {
    BlocProvider.of<SelectboxJenisKerusakanCubit>(context).getData();
    Widget _customPopupItemBuilderExample2(
        BuildContext context, JenisKerusakanModel item, bool isSelected) {
      return Container(
        ...
        child: ListTile(
          selected: isSelected,
          title: Text(item.namaJenisKerusakan.toString()),
    ...
    return Column(
      ...
      children: [
        ...
        DropdownSearch<JenisKerusakanModel>(
          validator: (value) {
            if (value == null) {
              return 'Jenis kerusakan Tidak Boleh kosong';
            }
            return null;
          },
          onChanged: (value) {
          ...
          compareFn: (item, sItem) =>
              item.kodeJenisKerusakan == sItem.kodeJenisKerusakan,
